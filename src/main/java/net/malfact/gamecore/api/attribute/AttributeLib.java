package net.malfact.gamecore.api.attribute;
...
public class AttributeLib extends TwoArgFunction {
    ...
    public static LuaUserdata getValueOf(AttributeInstance instance) {
    ...
    public static LuaUserdata getValueOf(AttributeModifier modifier) {
    ...
    private static class AttributeGetModifier extends TwoArgFunction {
        ...
        @Override
        public LuaValue call(LuaValue self, LuaValue key) {
            return getValueOf(self.checkuserdata(AttributeInstance.class).getModifier(LuaApi.toNamespacedKey(key.checkjstring())));
        }
    }
    ...
    private static class ModifierConstructor extends VarArgFunction {
        ...
        public Varargs invoke(Varargs args) {
            ...
            return getValueOf(new AttributeModifier(key, amount, operation, slotGroup));
        }
    }
